...
const navItems = [
  ...
  { name: "System Overview", href: "/system-overview", icon: Globe },
  { name: "Architecture Map", href: "/architecture", icon: Network },
  { name: "Project System", href: "/project-system", icon: FolderKanban },
  { name: "Wizard Flow", href: "/wizard-flow", icon: Workflow },
  { name: "Worker System", href: "/worker-system", icon: Cpu },
  { name: "Orchestrator", href: "/orchestrator", icon: Server },
  { name: "Job Queue", href: "/job-queue", icon: ListOrdered },
  { name: "Store Builder", href: "/store-builder", icon: ShoppingBag },
  { name: "Billing", href: "/billing", icon: CreditCard },
  { name: "AI Layer", href: "/ai-layer", icon: Brain },
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0a0a0f]/95 backdrop-blur-xl border-b border-white/10">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="border-t border-white/10 bg-[#0a0a0f] max-h-[calc(100vh-80px)] overflow-auto">
            ...
            <div className="p-4 border-t border-white/10">
              <div className="rounded-xl bg-gradient-to-br from-violet-500/10 to-pink-500/10 border border-violet-500/20 p-4">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:flex w-[280px] border-r border-white/10 bg-[#0a0a0f]/95 backdrop-blur-xl flex-col h-screen fixed left-0 top-0">
        <div className="p-5">
          <Link href="/" className="flex items-center gap-3">
            <ShoppDroppLogo className="w-10 h-10" />
            <ShoppDroppText className="text-xl" />
          </Link>
        </div>
