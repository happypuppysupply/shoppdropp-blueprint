...
`
  ...
  async function connectWebSocket() {
    try {
      ...
      // Always use backend WebSocket (avoids mixed content issues with direct worker connections)
      const wsUrl = `${API_URL.replace('https://', 'wss://').replace('http://', 'ws://')}/ws/ai-chat?token=${token}`
